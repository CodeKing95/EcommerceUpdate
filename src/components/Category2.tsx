               ...
               from-gray-300/90 to-gray-100 text-white rounded-3xl relative h-[320px]
                flex items-end'>
                        <div>
                            ...
                            opacity-40'>PlayStation 5 Pro</p>
                ...
                flex items-start'>
                        <div>
                            <div
                                ...
                                <p className='text-2xl font-semibold mb-[2px]'
                                ></p>
                                <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'></p>
                ...
                flex items-end'>
                        <div>
                            <div
                                ...
                                <p className='text-2xl font-semibold mb-[2px]'
                                >DR DRE</p>
                                <p className='text-4xl text-black xl:text-5xl font-bold opacity-20 mb-2'>Beats</p>
                        ...
                        <img
                            ...
                            data-aos-duration="500"
                            data-aos-once="true"
                            src={Image3} alt="" className='w-[200px] absolute
                    bottom-0 right-0'/>
                    </div>
                </div>
            </div>
