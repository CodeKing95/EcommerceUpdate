  ...
  <div className='min-h-[550px] flex justify-center items-center py-12'>
    ...
    className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl'>
            ...
            <div data-aos="zoom-in" className='h-full flex items-center'>
                <img src={data.image} alt="" className='scale-125 w-[250px] md:w-[150px] mx-auto drop-shadow-2xl object-cover' />
            </div>
            {/* third col */}
            ...
            sm:p-8'>
                ...
                <div data-aos="fade-up" data-aos-offset="0">
                    <button className='bg-primary text-white py-2 px-4 rounded-full'>Shop Now</button>
                </div>
            </div>
        </div>
        </div>
