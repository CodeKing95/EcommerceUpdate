...
/* Below is the blogs of recent tech news */
const BlogData = [
    {
                        ...
                        BlogData.map((data) => (
                            ...
                            rounded-2xl hover:scale-105 duration-500'
                                ...
                                <div className='space-y-2'>
                                    <p className='text-xs text-gray-500'>{data.
                                        published}</p>
                                    <p className='font-bold line-clamp-1'>{data.title}
                                    </p>
                                    <p className='line-clamp- text-sm text-gray-600
                        dark:text-gray-400'>
                                        {data.subtitle}
                                    </p>
                                </div>
